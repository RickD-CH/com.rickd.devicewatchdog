 ...
 *   includeBatteryForReporting: boolean,  // Off by default (see BATTERY_STALENESS_CAP_BASES
 *                                           // in lib/scanner.js): a still-updating battery
 *                                           // capability alone does not count as a sign of
 *                                           // life for the "not reporting" check. Turn on
 *                                           // for a device where only the battery reliably
 *                                           // reports and that should be enough evidence.
